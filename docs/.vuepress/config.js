...
module.exports = {
  ...
  themeConfig: {
    ...
    // categoryText: '随笔', // 碎片化文章（_posts文件夹的文章）预设生成的分类值，默认'随笔'
     ...
     bodyBgImg: [
      '/imgs/20200507175828.jpeg',
      '/imgs/20200507175845.jpeg',
      '/imgs/20200507175846.jpeg'
  ...
  head: [
    ['link', { rel: 'icon', href: '/img/cxy.png' }], //favicons，资源放在public文件夹
    [
      'meta',
      {
        name: 'keywords',
        content: 'Java博客,个人技术博客',
      },
    ],
